    ...
    def rewriteclan(self, original_clan_out_file):
        ...
        for line in lines:
            ...
            if pos!=-1:
                ...
                oldname = filename[lastslash+1:]
                basefilename = filename[lastslash+2:]
                suffix = basefilename.rfind(".")
                basefilename = basefilename[:suffix]
                # here add a few things to change the pdb file name
                basefilename = "/pdb" + basefilename + ".ent"
                #print "here:", basefilename
                ...
                line = line.replace(oldname, basefilename)
